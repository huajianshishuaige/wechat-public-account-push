...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx9a17df7433324717',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'd798d38d264f87370e64806c92fa08bf',
  ...
  USERS: [
    {
      ...
      id: 'oylEI6qEVlq0qKRf9fnmU8ov1PQw',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '66tsXnyxc7Kq09q9a7XpkGuc94Qdfo7wrThQ2_2yqTQ',
      // 所在省份
      province: '河南',
      // 所在城市
      city: '郑州',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '甜宝', year: '1999', date: '06-10',
        }
         ,
      ...
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2019-10-16' },
      ],
      // 课程表相关配置
  ...
  CALLBACK_USERS: [
    {
      ...
      id: 'oylEI6kGDmYRqqUZh5CeWyZ28ciE',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
